...
public class onFoot implements VisitBuildingWatsonI, DurationI, CostI, CarbonFootprintI, EffortI{

    private int calories = 42;
    private int CO2 = 35;
     ...
     */
    public onFoot() {
        MyLogger.writeMessage("Building: Watson - OnFoot class Constructor", MyLogger.DebugLevel.CONSTRUCTOR);
    }
    ...
    public String toString(){
        return "Watson Building onFoot Tour";
    }
